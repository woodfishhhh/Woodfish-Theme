...
[![Version](https://img.shields.io/badge/version-5.1.4--beta-blue.svg)](https://github.com/woodfishhhh/Woodfish-Theme)
...
```bash
code --install-extension woodfish-theme-5.1.4-beta.vsix
```
